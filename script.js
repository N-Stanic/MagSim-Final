...
document.querySelector('#navodila').addEventListener('click', alertnavodila);

function alertnavodila() {
  alert(
    'Pozdravljeni v simulaciji na temo toplote in energije.\nZa začetek nastavite moč grelca in moč hladilca ter ju vklopite.\nNa desni strani imate na voljo različne plošče: startno ploščo, rdečo grelno ploščo in modro hladilno ploščo.\nNa startni plošči se nahajajo različni materiali. Ko premaknete kurzor nad material, se prikažejo podatki o njem.\nVsi materiali so v obliki kock z maso 1 kg, njihove velikosti pa se razlikujejo glede na gostoto.\nS klikom na gumb "časovni korak" lahko čas premaknete za 1 sekundo. Če je čas v teku, vsaka kocka na grelni ali hladilni plošči prejme ali izgubi toliko energije, kot je nastavljeno za ploščo.\nS klikom na gumb "spremeni grafiko" lahko preklapljate med enostavno grafiko kvadratkov in grafiko s sličicami.\n\nNavodila lahko ponovno prikažete z klikom na gumb "navodila".\nS klikom na gumb "primeri" lahko prikažete primere različnih moči naprav in vsebin katere lahko raziščete s simulacijo.\n\nOpomba: Simulacija je namenjena osnovnošolcem, zato zanemarja izgubo toplote v okolico.\n\nKontakt: nino.stanic.1999@gmail.com'
  );
}

document.addEventListener('DOMContentLoaded', alertnavodila);

/*Alert za primere različnih moči*/
document.querySelector('#primeri').addEventListener('click', () => {
  alert(
    "Primeri raznih moči naprav\n\n1 W - Naprava (npr. televizija) v stanju pripravljenosti\n5 W - Vklopljen LED trak\n5 do 10 W - polnilci telefonov\n20 do 100W - Različni tipi žarnic\n50 do 100 W - Polnilci prenosnih računalnikov\n100 do 600 W - Stacionarni in 'gaming' računalniki\n100 do 400 W - Hladilnik in zmrzovalnik\n250 do 400 W - Sončni paneli\n1000 do 2000 W - Električni štedilniki\n1000 do 4000 W - Sušilec za oblačila\n4000 do 12000 W - Bojler za vodo\nS slajderjem lahko nastavite vrednost do 1000W, ampak v polje lahko tudi vnesete poljubno število.\n\nPrimeri uporabe: Primerjanje gostote različnih materialov, primerjanje toplotne kapacitete različnih materialov, primerjava hitrosti segrevanja različnih materialov, kateri material prej spremeni agregatno stanje, koncept absolutne ničle..."
  );
});
